...
var modal = bootstrap.Modal.getInstance(myModalEl) // Returns a Snowdrop modal instance
```
...
var modal = bootstrap.Modal.getOrCreateInstance(myModalEl) // Returns a Snowdrop modal instance
```
